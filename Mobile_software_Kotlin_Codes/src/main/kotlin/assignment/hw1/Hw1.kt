...
//        val b: Byte = d.toByte()  // Int 로 먼저 형변환 후 Byte 형변환 가능
    ...
    fun p12(v:Any=0){ // 형식 인자에는 val & var를 지정하지 않는다.
